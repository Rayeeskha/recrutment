...
<div class="container-fluid">
    ...
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link menu-link" href="{{ route('admin.our-services.index') }}">
                <i class="ri-pencil-ruler-2-line"></i> <span data-key="t-widgets">Our services</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link menu-link" href="#!">
                <i class="ri-pages-line"></i> <span data-key="t-widgets">Blog Category</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link menu-link" href="#!">
                <i class="ri-pencil-ruler-2-line"></i> <span data-key="t-widgets">Blog Post</span>
            </a>
        </li>
    </ul>
</div>
