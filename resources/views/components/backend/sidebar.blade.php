...
<!-- Dark Logo-->
<a href="{{ route('admin.contact-us.index') }}" class="logo logo-dark">
    <span class="logo-sm">
...
<!-- Light Logo-->
<a href="{{ route('admin.contact-us.index') }}" class="logo logo-light">
    <span class="logo-sm">
        <img src="{{ asset('assets/images/logo/logo.png') }}" alt="" height="22">
    </span>
    <span class="logo-lg">
    ...
    <ul class="navbar-nav" id="navbar-nav">
        <li class="nav-item">
            <a class="nav-link menu-link" href="{{ route('admin.contact-us.index') }}">
                <i class="ri-pencil-ruler-2-line"></i> <span data-key="t-widgets">Contact us</span>
            </a>
        </li>
    </ul>
</div>
